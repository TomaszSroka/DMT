...
window.FRONTEND_CONFIG = {
  ...
  text: {
    ...
    saveDialogTitle: "Review changes before complete",
    saveDialogIntro: "You are about to complete the following changes:",
    saveDialogBack: "Cancel",
    saveDialogConfirm: "Complete changes",
    emptyValue: "(empty)",
    publishNotReady: "Publish flow will be enabled in next iteration.",
    optimisticLockConflict: "Data changed on server. Reload Dictionary version and review changes before completing.",
